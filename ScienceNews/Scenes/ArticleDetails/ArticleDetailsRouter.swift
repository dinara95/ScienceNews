...
class ArticleDetailsRouter: NSObject, ArticleDetailsRoutingLogic, ArticleDetailsDataPassing
{
  ...
  //func navigateToSomewhere(source: ArticleDetailsViewController, destination: SomewhereViewController)
  //{
  ...
  //func passDataToSomewhere(source: ArticleDetailsDataStore, destination: inout SomewhereDataStore)
  //{
